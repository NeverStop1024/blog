...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    repo: 'NeverStop1024', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'NeverStop1024', // 必需
      link: 'https://github.com/NeverStop1024', // 可选的
    },

    // 博主信息 (显示在首页侧边栏)
    blogger: {
      avatar: 'https://cdn.jsdelivr.net/gh/NeverStop1024/images-store@main/blog/avatar_rVj0SP.png',
      name: '董先亮',
      slogan: '前端react开发',
    },
    ...
    social: {
      ...
      icons: [
        ...
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
          link: 'https://www.kugou.com/song/#hash=8D27A0FD0D8B6A9059D3FEEC95E2088D&album_id=976268',
        },
      ],
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'NeverStop1024 | <a href="https://github.com/NeverStop1024" target="_blank">MIT License</a>', // 博客版权信息，支持a标签或换行标签</br>
    },
